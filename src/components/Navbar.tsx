    ...
    if (value.length >= 3) {
      try {
        const response = await axios.get(
          `https://api.openweathermap.org/data/2.5/find?q=${value}&appid=6a74d0568f1e312900c750047ab804ef`
        );
      ...
      <nav className="shadow-sm  sticky top-0 left-0 z-50 bg-black">
        <div className="h-[80px] w-full flex justify-between items-center max-w-7xl px-3 mx-auto">
          <p className="flex items-center justify-center gap-2  ">
            <h2 className="text-gray-300 text-3xl">Weather & Forecast</h2>
          ...
          <section className="flex gap-2 items-center">
            ...
            <p className="text-slate-100/80 text-sm"> {location} </p>
